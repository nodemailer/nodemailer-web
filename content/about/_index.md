...
\
Using the email accounts registered with EmailEngine, you can receive emails and [send emails](https://emailengine.app/sending-emails). EmailEngine supports OAuth2, delayed sends, opens and clicks tracking, bounce detection, etc. All on top of regular email accounts without an external MTA service.
